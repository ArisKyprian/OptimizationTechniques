...
k3 = int8.empty(0,3);
for i = 1:3
    [a1{i}, b1{i}, Fcounter1(i), k1(i)] = dixotomouDerivative(lambda,f1);
    [a2{i}, b2{i}, Fcounter2(i), k2(i)] = dixotomouDerivative(lambda,f2);
    [a3{i}, b3{i}, Fcounter3(i), k3(i)] = dixotomouDerivative(lambda,f3);
    L(i) = lambda;
    lambda = lambda + 0.02;
end
...
for i = 1:3 %lambda = 0.01 0.03 0.05 and f1;
    ...
    ab = [a1{i,1} ; b1{i,1}];
    k = 1:(k1(i)+1);
    scatter(k,ab); title("BisectionDerivative for lambda = "+ L(i) + " and f1");
...
for i = 1:3 %lambda = 0.01 0.03 0.05 and f2;
    ...
    ab = [a2{i,1} ; b2{i,1}];
    k = 1:(k2(i)+1);
    scatter(k,ab); title("BisectionDerivative for lambda = "+ L(i) + " and f2");
    xlabel('Step'); ylabel('Edges');
end
...
for i = 1:3 %lambda = 0.01 0.03 0.05 and f3;
    ...
    ab = [a3{i,1} ; b3{i,1}];
    k = 1:(k3(i)+1);
    scatter(k,ab); title("BisectionDerivative for lambda = "+ L(i) + " and f3");
    xlabel('Step'); ylabel('Edges');
end
